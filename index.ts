...
import { detailsThreeColumnStyles } from './details-three-column-styles';

import '../../designSystemExtension/DetailsFields';
import { RowDetailsMixinClass } from '@vaadin/grid/src/vaadin-grid-row-details-mixin';

// Declare that PCore will be defined when this code is run
declare var PCore: any;


@customElement('details-three-column-component')
class DetailsThreeColumn extends BridgeBase {
  ...
  connectedCallback() {
    ...
    this.theComponentStyleTemplate = detailsThreeColumnStyles;
  ...
  render(){
    ...
    const theContent = html`
      <div class="psdk-grid-filter">
        ...
        <div>
            <details-fields-extension .arFields="${this.arFields3}"></details-fields-extension>
        </div>
      </div>
    `;
...
export default DetailsThreeColumn;